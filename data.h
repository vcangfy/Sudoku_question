...
namespace data
{
    ...
    array<array<int, 9>, 9> board_highdiffi = {{
        {{0, 7, 0, 0, 0, 0, 0, 3, 0}},  // 第0行
        {{0, 0, 0, 0, 0, 2, 9, 0, 1}},  // 第1行
        {{0, 0, 5, 9, 0, 0, 0, 0, 0}},  // 第2行
        {{8, 0, 0, 0, 0, 0, 7, 0, 0}},  // 第3行
        {{0, 0, 3, 6, 8, 0, 0, 0, 4}},  // 第4行
        {{1, 0, 0, 0, 0, 0, 0, 5, 0}}, // 第5行
    ...
    array<array<int, 9>, 9> board_extremediffi = {
        ...
        array<int,9>{0, 0, 0, 6, 0, 1, 0, 4, 3},
        array<int,9>{0, 0, 0, 0, 0, 0, 0, 0, 0},
        array<int,9>{0, 1, 0, 5, 0, 0, 0, 0, 0},
        array<int,9>{0, 0, 7, 0, 0, 0, 3, 0, 0},
        array<int,9>{6, 0, 0, 0, 0, 0, 0, 0, 0},
