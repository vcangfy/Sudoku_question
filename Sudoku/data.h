...
namespace data
{
    ...
    array<array<int, 9>, 9> board_highdiffi = {{
        {{0, 7, 0,    0, 0, 0,    0, 3, 0}}, 
        {{0, 0, 0,    0, 0, 2,    9, 0, 1}}, 
        {{0, 0, 5,    9, 0, 0,    0, 0, 0}}, 
    ...
    array<array<int, 9>, 9> board_extremediffi = {
        array<int,9>{  0,  0,  0,    0,  0,  0,    0,  0,  0,},
        array<int,9>{  0,  0,  9,    5,  0,  0,    0,  0,  7,},
        array<int,9>{  0,  8,  0,    0,  6,  0,    0,  5,  0,},

        array<int,9>{  0,  5,  0,    0,  4,  0,    0,  3,  0,},
        array<int,9>{  0,  0,  7,    9,  0,  0,    0,  0,  1,},
        array<int,9>{  0,  0,  0,    0,  0,  0,    0,  0,  0,},

        array<int,9>{  0,  0,  2,    7,  0,  0,    0,  0,  9,},
        array<int,9>{  0,  4,  0,    0,  8,  0,    0,  6,  0,},
        array<int,9>{  3,  0,  0,    0,  0,  1,    2,  0,  0,},
    };

    // perfect question
    // array<int,9>{  0,  0,  0,    0,  0,  0,    0,  0,  0,},
    // array<int,9>{  0,  0,  9,    8,  0,  0,    0,  0,  7,},
    // array<int,9>{  0,  8,  0,    0,  6,  0,    0,  5,  0,},
    ...
    // array<int,9>{  0,  0,  2,    7,  0,  0,    0,  0,  9,},
    // array<int,9>{  0,  4,  0,    0,  5,  0,    0,  6,  0,},
    // array<int,9>{  3,  0,  0,    0,  0,  6,    2,  0,  0,},
